         ...
         <table width="560" height="326" border="3"  class="tftable">
          <tbody>
            ...
            <tr>
              ...
              <td><input class="form-control" type="date" name="moneyorderdate" id="moneyorderdate" value="<?php echo $rsedit['modate'];?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input class="form-control" type="text" name="commission" id="commission" value="<?php echo $rsedit['commission'];?>" readonly="readonly" /></td>
            </tr>
            <tr>
